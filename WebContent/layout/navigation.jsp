...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href='<s:url value="/"></s:url>'><img
				alt="Logo" src="/JavaProject02/image/common/logo.png" height="40"
				width="auto"></a>
		</div>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li><a href='<s:url value="/"></s:url>'>Home<span
						class="sr-only">(current)</span></a></li>
				<s:if test="#session.user">
					<li><a href='<s:url value="/word/listAll"></s:url>'>Word List</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						aria-expanded="false"><s:property
								value="#session.user.username" /><span class="caret"></span></a>
