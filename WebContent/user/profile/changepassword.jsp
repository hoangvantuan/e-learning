...
<div class="container">
    ...
    <div class="row update-form">
        <div class="col-md-5 col-md-offset-3">
            ...
            <br>
            <s:form class="form-horizontal" method="POST" action="/user/changePassword">
                <div class="form-group row">
                    <label for="oldPassword" class="col-md-3 control-label">Old password*</label>
                    <div class="col-md-9">
                      <input type="password" class="form-control" id="oldPassword"
                            name="password.oldPassword" placeholder="Old password" required="required">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="password" class="form-control" id="newPassword"
                            name="password.newPassword" placeholder="New password" required="required">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="password" class="form-control" id="confirmPassword"
                            name="password.confirmPassword" placeholder="Confirm password" required="required">
                    </div>
                </div>
